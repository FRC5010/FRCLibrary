...
public class RobotContainer {
  ...
  private static DrivetrainPoseEstimator poseEstimator;
  ...
  private void configureButtonBindings() {
    ...
    controller.setLeftYAxis(controller
      .createLeftYAxis()
      .deadzone(0.06)
      .negate()
      .cubed());
    controller.setRightXAxis(controller.createRightXAxis().deadzone(0.06).cubed());  
  ...
  public Command getArcadeDriveCommand() {
    return new ArcadeDrive(
        m_drivetrain, () -> controller.getLeftYAxis(), 
