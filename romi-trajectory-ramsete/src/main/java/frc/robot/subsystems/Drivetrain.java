...
import org.frc5010.common.sensors.encoder.WpiEncoder;
import org.frc5010.common.sensors.gyro.ROMIGyro;
...
public class Drivetrain extends SubsystemBase {
  ...
  private final GenericEncoder m_leftEncoder = new WpiEncoder(new Encoder(4, 5));
  private final GenericEncoder m_rightEncoder = new WpiEncoder(new Encoder(6, 7));
  ...
  public Drivetrain(VisionSystem vision) {
    // Use inches as unit for encoder distances
    m_leftEncoder.setPositionConversion((Math.PI * kWheelDiameterMeter) / kCountsPerRevolution);
    m_rightEncoder.setPositionConversion((Math.PI * kWheelDiameterMeter) / kCountsPerRevolution);
    resetEncoders();

    poseEstimator = new DrivetrainPoseEstimator(new DifferentialPose(Constants.DriveConstants.kDriveKinematics, m_gyro, m_leftEncoder, m_rightEncoder), vision);
