...
public class DifferentialPose extends GenericPose {
    ...
    public void updateLocalMeasurements() {
        ...
        // actWheelSpeeds = new DifferentialDriveWheelSpeeds(leftEncoder.getVelocity(), rightEncoder.getVelocity());
    ...
    public void resetToPose(Pose2d pose) {
        poseEstimator.resetPosition(getGyroRotation2d(),leftEncoder.getPosition(),rightEncoder.getPosition(),pose);
    }
}
