...
public class DriveByAngle extends CommandBase {
    ...
    public DriveByAngle(GenericDrivetrain drivetrainSubsystem,
    ...
    public void execute() {
        ...
        double r = Math.max(Math.min(Math.atan2(m_rotationXSupplier.getAsDouble(), m_rotationYSupplier.getAsDouble()) - drivetrainSubsystem.getHeading().getRadians(), 1), -1);
