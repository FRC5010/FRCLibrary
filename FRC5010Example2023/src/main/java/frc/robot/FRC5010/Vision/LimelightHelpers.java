...
public class LimelightHelpers {
    ...
    public static boolean isValid(String limelightName) {
        return getLimelightNTDouble(limelightName, "tv") == 1.0;
    }

    public static boolean isLightOn(String limelightName) {
        return getLimelightNTDouble(limelightName, "modeLed") == 1.0;
    }
    ...
    public static void resetSnapshotMode(String LimelightName){
        setLimelightNTDouble(LimelightName, "snapshot", 0);
    }

    public static void takeSnapshot(String LimelightName){
        setLimelightNTDouble(LimelightName, "snapshot", 1);
    }
