...
public abstract class GenericDrivetrain extends SubsystemBase {
    ...
    protected double maxChassisVelocity;
    ...
    public void setMaxChassisVelocity(double max) {
        maxChassisVelocity = max;
    }

    public double getMaxChassisVelocity() {
        return maxChassisVelocity;
    }

    public void setMaxRotationVelocity(double max) {
        maxRotationVelocity = max;
    }
