...
public class GenericMotorConstants {
    ...
    private double kEncoderConversion;
    ...
    public void setEncoderConversion(double conversion) {
        kEncoderConversion = conversion;
    }

    public double getEncoderConversion() {
        return kEncoderConversion;
    }
}
