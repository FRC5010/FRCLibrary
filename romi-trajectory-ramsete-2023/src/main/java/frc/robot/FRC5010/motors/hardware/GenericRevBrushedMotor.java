...
/** Add your docs here. */
public class GenericRevBrushedMotor extends CANSparkMax implements MotorController5010 {
    protected int currentLimit;

    public GenericRevBrushedMotor(int port, int currentLimit) {
    ...
    public MotorController5010 duplicate(int port) {
        MotorController5010 duplicate = new GenericRevBrushedMotor(port, currentLimit);
        return duplicate;
    }
