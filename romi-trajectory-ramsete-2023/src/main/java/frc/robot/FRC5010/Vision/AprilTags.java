...
public class AprilTags {
    ...
    public static enum AprilTag5010 {
        ...
        ID0(0.464, 3.0226, 0.1178, 0, -90),
        ID1(3.251, 2.8575, 0.2413, 0, 0),
        ID2(0, 0.7747, 0.3048, 0, 0),
        ID3(0, 0, 0, 0, 0),
        ID4(0, 0, 0, 0, 0),
        ID5(0, 0, 0, 0, 0),
        ID6(0, 0, 0, 0, 0),
        ...
        ID26("Corner Cabinet 1", Units.inchesToMeters(14.25), Units.inchesToMeters(20.375),
                Units.inchesToMeters(70.875), Units.degreesToRadians(0), Units.degreesToRadians(0)),
        ID27("Belts Cabinet", Units.inchesToMeters(14.25), Units.inchesToMeters(116.25), Units.inchesToMeters(70.875),
        ...
        ID29("Tack Board 1", Units.inchesToMeters(94.125), Units.inchesToMeters(.75), Units.inchesToMeters(69.75),
