...
public class VerticalLimeLight extends VisionLimeLight {
  ...
  // class for when the limelight is mounted "normally" or where the leds are
  ...
  public VerticalLimeLight(String name, double camHeight, double camAngle, double targetHeight, int colIndex,
