...
public final class Constants {
    ...
    public static final class Field {
        ...
        public static final Pose3d SPEAKER_POSE_BLUE = new Pose3d(
                ...
                new Rotation3d());
        private static final Transform3d SHOT_OFFSET = new Transform3d(
                new Translation3d(0.0, Units.inchesToMeters(-9.055), Units.inchesToMeters(80.515)),
                new Rotation3d());
        public static Pose3d SHOT_POSE = SPEAKER_POSE_BLUE.plus(SHOT_OFFSET);
    }
}
