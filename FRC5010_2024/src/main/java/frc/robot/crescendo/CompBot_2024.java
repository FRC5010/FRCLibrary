...
public class CompBot_2024 extends GenericMechanism {
	...
	public void configureButtonBindings(Controller driver, Controller operator) {
		...
		rumbleOperator = () -> Commands.deadline(Commands.waitSeconds(0.5), Commands.runOnce(() -> operator.setRumble(1)))
		...
		runFeeder = () -> Commands.run(() -> feederSubsystem.feederStateMachine(-values.getDouble("FeederSpeed")),
				feederSubsystem)
		...
		operator.createStartButton()
				.onTrue(Commands.runOnce(() -> climbSubsystem
						...
						.andThen(rumbleOperator.get().onlyIf(() -> climbSubsystem.getAutobalanceMode())));
