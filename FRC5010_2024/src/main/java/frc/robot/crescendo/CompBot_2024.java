...
public class CompBot_2024 extends GenericMechanism {
        ...
        public CompBot_2024(Mechanism2d visual, ShuffleboardTab displayTab) {
                ...
                feederShooterMotor = MotorFactory.NEO(11); //MotorFactory.NEO(11);
        ...
        public void setupDefaultCommands(Controller driver, Controller operator) {
                // pivotSubsystem.setDefaultCommand(new RunPivot(() -> operator.getRightYAxis(), pivotSubsystem)); // TODO: Add way to control
                shooterSubsystem.setDefaultCommand(new RunShooter(() -> operator.getLeftTrigger() - operator.getRightTrigger(), () -> operator.getLeftTrigger() - operator.getRightTrigger(), shooterSubsystem));
                //climbSubsystem.setDefaultCommand(new RunClimb(() -> operator.getLeftYAxis(), () -> operator.getRightYAxis(), climbSubsystem));
                intakeSubsystem.setDefaultCommand(new RunIntake(() ->  driver.getRightTrigger() - driver.getLeftTrigger(), () -> values.getDouble("FeederSpeed"), intakeSubsystem, shooterSubsystem));
