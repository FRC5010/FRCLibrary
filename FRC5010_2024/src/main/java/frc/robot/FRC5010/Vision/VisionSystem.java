...
public abstract class VisionSystem extends SubsystemBase {
	...
	public VisionSystem(String name, DoubleSupplier camHeight, DoubleSupplier camAngle, DoubleSupplier cameraDistance,
			double targetHeight,
			int colIndex,
	...
	protected void updateValues(VisionValues rawValues,
		...
		if (valid) {
			...
			if (null != cameraPoseSupplier.get() && null != robotPoseSupplier.get()) {
				...
				distance = (targetHeight - camHeight.getAsDouble())
