...
public class SmoothedValueSwitch extends ValueSwitch {
    ...
    public SmoothedValueSwitch(Supplier<Double> threshold, Supplier<Double> value, double triggerThreshold) {
    ...
    @Override
    public Boolean get() {
        return (valueFilter.calculate(valueSupplier.get()) - thresholdSupplier.get()) > triggerThreshold;
    }
