...
public class SwerveDrivetrain extends GenericDrivetrain {
    ...
    public SwerveDrivetrain(Mechanism2d mechVisual,
        ...
        poseEstimator = new DrivetrainPoseEstimator(new SwervePose(gyro, swerveConstants.getKinematics(), this),
                visonSystem);
    ...
    public SwerveModulePosition[] getModulePositions() {
        return new SwerveModulePosition[] {
                ...
                new SwerveModulePosition(frontRight.getDrivePosition(),
                        new Rotation2d(frontRight.getTurningPosition())),
