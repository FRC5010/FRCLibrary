...
/**
 * To setup a copy of this class Copy to a new class and rename the constructor In RobotFactory add
 * constants and a switch-case for your class Start PhotonVision and get the camera name (java -jar
 * photonvision.jar) Start the robot simulation In Glass - find the
 * NetworkTables->Preferences->WhoAmI and set it to your robot name Also change the LaptopCamera
 * name from photon vision Stop the simulator, restart and it should start your robot code
 */
