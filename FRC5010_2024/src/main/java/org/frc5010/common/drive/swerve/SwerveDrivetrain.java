...
public class SwerveDrivetrain extends GenericDrivetrain {
	...
	public SwerveDrivetrain(
			Mechanism2d mechVisual, GenericDrivetrainConstants swerveConstants) {
		super(mechVisual);
		this.swerveConstants = swerveConstants;
	}
	...
	public void drive(ChassisSpeeds direction) {
		...
		SwerveModuleState[] states = ((SwerveConstants)swerveConstants).getKinematics().toSwerveModuleStates(chassisSpeeds);
